...
def analysis(): return {"schema_version":"script-analysis.v3","script_analysis_id":"SCRIPT_CTX","source_script":{"path":"script.md","sha256":"a"*64},"facts":[],"unresolved_questions":[],"review_status":"REVIEWED"}
